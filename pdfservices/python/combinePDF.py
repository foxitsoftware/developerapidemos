...
print(f"Uploaded pdf to Foxit, id is {doc1['documentId']}")

doc2 = uploadDoc("../../inputfiles/second.pdf", CLIENT_ID, CLIENT_SECRET)
print(f"Uploaded second pdf to Foxit, id is {doc2['documentId']}")
...
downloadResult(result["resultDocumentId"], "../../output/input_combined.pdf", CLIENT_ID, CLIENT_SECRET)
print("Done and saved to: ../../output/input_combined.pdf")