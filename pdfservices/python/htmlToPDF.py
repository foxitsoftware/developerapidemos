...
doc = uploadDoc("../../inputfiles/input.html", CLIENT_ID, CLIENT_SECRET)
...
downloadResult(result["resultDocumentId"], "../../output/fromhtml.pdf", CLIENT_ID, CLIENT_SECRET)
print("Done and saved to: ../../output/fromhtml.pdf")