...
def compressPDF(doc, id, secret, level="MEDIUM"):
...
downloadResult(result["resultDocumentId"], "../../output/input_compressed.pdf", CLIENT_ID, CLIENT_SECRET)
print("Done and saved to: ../../output/input_compressed.pdf")