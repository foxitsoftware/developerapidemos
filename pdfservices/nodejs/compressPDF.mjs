...
await downloadResult(result.resultDocumentId, "../../output/node_input_compresses.pdf", CLIENT_ID, CLIENT_SECRET);
console.log("Done and saved to: ../../output/node_input_compresses.pdf");